...
public class FileInfo
{
	...
	// use this for positioning later
	int parentToX;
	int parentToY;
	...
	//call this if your part is changing file at all, IE gender, age, species, or slot updates
	public void updateFile(int part, int pose, int dirn, int expression, int gspcs, int age, char slot, int eyes) {
		//build your ideal filename
		...
		//now update the frame (this also gathers all the ATTs)
	...
	public void updateFrame(int part, int pose, int dirn, int expression, int eyes)
	{
		this.frame = getFrame(part, pose, dirn, expression, eyes);
		updateATTs(part, pose, dirn);
	}
	
	public void updateATTs(int part, int pose, int dirn)
	{
